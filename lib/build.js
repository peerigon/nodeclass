...
function build(classModule) {
    ...
    if(typeof classModule.module.exports !== 'object') {
        throw new Error('This module doesn\'t export anything');
    }

    // Collecting all properties of this class and all inherited properties
    This = collect.collectProperties(classModule.module.exports);
    if(typeof classModule.module.exports.Extends === 'object') {
        Super = collect.collectSuperProperties(classModule.module.exports.Extends.module.exports);
        This.Overridden = collect.collectOverriddenProperties(This, Super);
        This.ImplementedAbstracts = collect.collectImplAbstracts(
            classModule.module.exports,
